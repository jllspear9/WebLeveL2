...
<body>
    ...
    <!-- conteneur de saisie de l'utilisateur -->
        ...
        <fieldset>
            ...
            <!-- formulaire de saisie & redirection+envoie dans le fichier affichage-->
            <form action="./affichage.php" method="POST" id="formulaire">
                <!-- champs de saisie -->
                ...
                <input type="number" name="numage" id="age" placeholder="age" required>  
